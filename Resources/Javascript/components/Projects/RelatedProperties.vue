          ...
          <div class="property-entry h-100">
            ...
            <div class="p-4 property-body">
              ...
              <span class="property-location d-block mb-3">
                <span class="property-icon icon-room" /> 625 S. Berendo St Unit 607 Los Angeles, CA 90005
              </span>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="property-entry h-100">
            ...
            <div class="p-4 property-body">
              <a
                href="#"
                class="property-favorite active"
              >
                <span class="icon-heart-o" />
              </a>
              <h2 class="property-title">
              ...
              <span class="property-location d-block mb-3">
                <span class="property-icon icon-room" /> 1 New York Ave, Warners Bay, NSW 2282
              </span>
              <strong class="property-price text-primary mb-3 d-block text-success">
                $2,265,500
              </strong>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="property-entry h-100">
            ...
            <div class="p-4 property-body">
              ...
              <span class="property-location d-block mb-3">
                <span class="property-icon icon-room" /> 853 S Lucerne Blvd Unit 101 Los Angeles, CA 90005
              </span>
              <strong class="property-price text-primary mb-3 d-block text-success">
                $2,265,500
              </strong>
