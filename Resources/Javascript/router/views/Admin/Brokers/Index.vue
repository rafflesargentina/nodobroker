    ...
    <div class="card">
        ...
        <div class="row">
          ...
          <div class="col-md-3 offset-md-4">
            <RouterLink
              ...
              :to="{ name: 'AdminBrokersCreate' }"
            >
              <span class="fa fa-plus pr-2" />Nuevo Broker
            </RouterLink>
          </div>
        </div>
      </div>
      <div v-if="$refs.quickSearch">
        ...
        >
          ...
          >
            <RouterLink 
              :to="{ name: 'AdminBrokersEdit', params: { id: item.id } }" 
              class="mr-2"
            >
            ...
            <a 
              href="#" 
              @click="destroyRecordConfirmation('/api/brokers/' + item.id, item.id)"
            >
...
<script>
import { brokersComputed, brokersMethods } from "../../../../store/helpers"
...
export default {
    ...
    methods: {
        ...
        prepare() {
            return this.$store.dispatch("brokers/fetchAllBrokers")
        }
    }
}
</script>
